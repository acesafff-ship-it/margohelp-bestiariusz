...
(function () {
  ...
  const LAUNCH_ICON = 'https://acesafff-ship-it.github.io/ysspack/assets/module-bestiary-enabled.png';
  ...
  style.textContent = `
    ...
    .kyf-launch.kyf-widget-dragging{position:fixed!important;z-index:110!important;cursor:grabbing!important;pointer-events:none!important;opacity:.9}
    .kyf-widget-tooltip{position:fixed;display:none;z-index:110;min-width:132px;padding:8px 14px;border:2px solid #7d858c;outline:2px solid #17191a;background:linear-gradient(#111,#050505);box-shadow:0 2px 7px #000,inset 0 0 0 1px #30363a;color:#eee;text-align:center;white-space:nowrap;pointer-events:none;font:12px/15px Verdana,Arial,sans-serif;text-shadow:1px 1px #000}
  ...
  function setStatus(_text, category = activeCategory) {
    ...
    panel.querySelector('#kyf-status').innerHTML = `<span class="kyf-garmory-credit">Grafiki są własnością <a href="https://garmory.pl/" target="_blank" rel="noopener noreferrer">Garmory</a>.</span> | <a href="${config.source}" target="_blank" rel="noopener">Otwórz ${escapeHtml(linkLabel)}</a>`;
  }
})();
