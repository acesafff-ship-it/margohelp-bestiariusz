...
(function () {
  ...
  const SCRIPT_VERSION = '2.2.28';
  const SCRIPT_UPDATED_AT = new Date('2026-07-22T20:18:53+02:00').getTime();
  const SCRIPT_RELEASE_NOTES = 'Odświeżony wygląd zgodny z interfejsem gry, poprawione dymki i oznaczenia wymagań przedmiotów oraz pełna ramka panelu.';
    ...
    overlay.innerHTML = `
      <div class="kyf-release-popup" role="dialog" aria-modal="true" aria-labelledby="kyf-release-title">
        ...
        <div class="kyf-release-popup-body">
          <ul><li>Odświeżony wygląd zgodny z interfejsem gry.</li><li>Poprawione dymki oraz oznaczenia wymagań przedmiotów.</li><li>Pełna, dopracowana ramka panelu z każdej strony.</li></ul>
