...
(function () {
  ...
  const SCRIPT_VERSION = '2.2.38';
  const SCRIPT_UPDATED_AT = new Date('2026-07-28T00:10:00+02:00').getTime();
  const SCRIPT_RELEASE_NOTES = 'Dodano nowe logo Bestiariusza oraz poprawiono widoczność informacji o własności grafik Garmory.';
    ...
    overlay.innerHTML = `
      <div class="kyf-release-popup" role="dialog" aria-modal="true" aria-labelledby="kyf-release-title">
        ...
        <div class="kyf-release-popup-body">
          <ul><li>Dodano nowe logo Bestiariusza — czaszkę z księgą.</li><li>Poprawiono widoczność informacji, że wykorzystane grafiki są własnością Garmory.</li><li>Dodano bezpośredni link do strony Garmory.</li></ul>
