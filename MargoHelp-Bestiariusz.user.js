...
(function () {
  ...
  const SCRIPT_UPDATED_AT = new Date('2026-07-22T20:22:41+02:00').getTime();
  const SCRIPT_RELEASE_NOTES = 'Odświeżony wygląd zgodny z interfejsem gry, poprawione dymki i wymagania przedmiotów, pełna ramka panelu oraz dwukrotnie większe grafiki potworów.';
    ...
    overlay.innerHTML = `
      <div class="kyf-release-popup" role="dialog" aria-modal="true" aria-labelledby="kyf-release-title">
        ...
        <div class="kyf-release-popup-body">
          <ul><li>Odświeżony wygląd zgodny z interfejsem gry.</li><li>Poprawione dymki oraz oznaczenia wymagań przedmiotów.</li><li>Pełna ramka panelu i dwukrotnie większe grafiki potworów.</li></ul>
